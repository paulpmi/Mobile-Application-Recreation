...
export default class Reference extends ReferenceBase {
  ...
  set(value, onComplete) {
    return promiseOrCallback(this._database._native.set(this.path, this._serializeAnyType(value)), onComplete);
  }
  ...
  setPriority(priority, onComplete) {
    ...
    return promiseOrCallback(this._database._native.setPriority(this.path, _priority), onComplete);
  }
  ...
  setWithPriority(value, priority, onComplete) {
    ...
    return promiseOrCallback(this._database._native.setWithPriority(this.path, _value, _priority), onComplete);
  }
  ...
  update(val, onComplete) {
    ...
    return promiseOrCallback(this._database._native.update(this.path, value), onComplete);
  }
   ...
   */
  remove(onComplete) {
    return promiseOrCallback(this._database._native.remove(this.path), onComplete);
  }
  ...
  once(eventName = 'value', successCallback, cancelOrContext, context) {
    return this._database._native.once(this._getRefKey(), this.path, this._query.getModifiers(), eventName).then(({ snapshot }) => {
  ...
  push(value, onComplete) {
    ...
    if (isFunction(onComplete)) {
      return promise.then(() => onComplete(null, newRef)).catch(error => onComplete(error, null));
    }
  ...
  off(eventType = '', originalCallback) {
    ...
    this._syncTree.removeListenersForRegistrations(this._syncTree.getRegistrationsByPathEvent(this.path, `${eventType}$cancelled`));
